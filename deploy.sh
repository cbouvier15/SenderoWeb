...
if [ $# -gt 0 ]; then
	...
	if $DEPLOY_SENDERO ; then
		...
		cp -r views/index.html public/styles public/images public/views $SENDERO_PATH
		cp -r public/js/socket.io.min.js $SENDERO_PATH"js"
	...
	if $DEPLOY_WEB ; then
		...
		cp -r public/js/lz4.min.js public/js/stats.js public/js/heartcode-canvasloader-min.js public/js/OBJLoader.js public/js/interaction.js public/js/streaming.js public/js/three.min.web.js public/js/xml.parser.js public/js/OrbitControls.web.js public/js/socket.io.min.js public/js/three.helper.js public/js/underscore-min.js $WEB_PATH"js"
		echo "Web deployed!"
		echo
	fi
